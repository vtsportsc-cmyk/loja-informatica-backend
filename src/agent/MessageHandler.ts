...
import type { SuriBotResponse, SuriInbound, SuriTicketStatus } from '../types/index.js';
...
export class MessageHandler {
  ...
  async processInbound(inbound: SuriInbound): Promise<SuriBotResponse> {
  ...
  private async processLocked(inbound: SuriInbound): Promise<SuriBotResponse> {
  ...
  private async loadOrCreate(inbound: SuriInbound): Promise<SessionState> {
...
function statusForState(state: BotStateId): SuriTicketStatus {
  switch (state) {
