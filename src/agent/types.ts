import type { SuriInbound, SuriBotResponse } from '../types/index.js';
...
export interface SessionState {
  ...
  botState: BotStateId;
  customerId: string;
  /** Dados do cliente no SURI (para eventos de CRM/ERP). */
  customerName?: string;
...
export interface MessageHandlerDeps {
  ...
  processInbound(inbound: SuriInbound): Promise<SuriBotResponse>;
}
