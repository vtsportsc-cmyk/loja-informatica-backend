...
import type { SuriApi } from '../integration/suri/SuriApi.js';
...
// do trycompai/crm chama POST /webhooks/crm/follow-up quando detecta, por
// exemplo, carrinho parado ha +2 horas. O handler valida o payload, recupera a
// sessao no SessionStore e dispara a mensagem de reengajamento via SURI.
// ============================================================================
